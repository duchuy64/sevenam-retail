...
Bộ công cụ nội bộ tổng hợp 4 dashboard báo cáo Seven.AM trong **một link duy nhất**, chia thành 4 tab độc lập.
...
Mỗi báo cáo chạy trong vùng độc lập để CSS/JS/Canvas không xung đột. Dữ liệu của 4 tool vẫn lưu cục bộ trên trình duyệt bằng các `localStorage` key riêng biệt.
...
6. GitHub sẽ cung cấp một URL Pages. Mở URL đó là vào Hub 4 tab.
...
Muốn cập nhật một báo cáo riêng, chỉ cần thay các file trong thư mục tương ứng `modules/bc1`, `modules/bc2`, `modules/bc3` hoặc `modules/bc4`. Không cần sửa Hub nếu tên đường dẫn không đổi.
